...
entity kuuga_test_harness is
  ...
  attribute CORE_GENERATION_INFO of kuuga_test_harness : entity is "kuuga_test_harness,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=kuuga_test_harness,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=2,numReposBlks=2,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,synth_mode=Global}";
...
architecture STRUCTURE of kuuga_test_harness is
  ...
  signal Agito_CLK_1 : STD_LOGIC;
  signal Agito_Input_Loc_1 : STD_LOGIC_VECTOR ( 31 downto 0 );
  signal Agito_RST_1 : STD_LOGIC;
