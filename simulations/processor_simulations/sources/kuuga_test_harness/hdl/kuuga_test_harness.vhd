...
entity kuuga_test_harness is
  ...
  attribute CORE_GENERATION_INFO of kuuga_test_harness : entity is "kuuga_test_harness,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=kuuga_test_harness,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,synth_mode=Global}";
...
begin
  CLK_1 <= CLK;
  RST_1 <= RST;
  done <= kuuga_0_ap_done;
  input_location_1(31 downto 0) <= input_location(31 downto 0);
  result(31 downto 0) <= kuuga_0_ap_return(31 downto 0);
  start_1 <= start;
